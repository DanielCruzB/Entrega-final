...
export class UsuarioService {
  private apiUrlUsuarios = 'http://192.168.228.247:3000/api/usuarios';
  private apiUrlViajes = 'http://192.168.228.247:3000/api/viajes';
  private apiUrlReservas = 'http://192.168.228.247:3000/api/reservas';
